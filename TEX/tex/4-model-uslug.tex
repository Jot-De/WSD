...
{\color{teal}System SmartPark został zaprojektowany zgodnie z wytycznymi metodologii GAIA. }

\subsection{Identyfikacja ról}
{\color{teal}Role agenta CarAgent:}
\begin{enumerate}
...
\begin{itemize}
    ...
    \item {\color{teal}może zrezygnować z zarezerwowanego miejsca}
\end{itemize}
{\color{teal}Role agenta ParkingAgent: }
...
\begin{table}[!h] \label{tab:rola1} \centering
    ...
    \begin{tabular} {| p{14cm} |} \hline
        ...
        {\color{teal}reads: sensors\_data}
