...
\author{Jan Dubiński | numer albumu}
\secondAuthor{Joanna Kaleta | numer albumu}
\thirdAuthor{Aleksander Ogonowski | numer albumu}
\fourthAuthor{Maria Oniszuczuk | numer albumu}
...
% Rozdziały
%--------------------------------------
\input{tex/1-opis-problemu}
\input{tex/2-opis-systemu}
\input{tex/3-architektura-systemu}
